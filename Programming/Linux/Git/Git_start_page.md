...
5. [Why there are merge conflicts during a rebase?](./merge_conflikts_during_rebase.md)
6. [How to handle a git rebase conflict?](./Handling_Rebase_Conflicts.md)
7. [Git rebase tutorial](./git_rebase_tutorial.md)
8. [Git rebase bootcamp](./Git_Rebase_Bootcamp.md)
